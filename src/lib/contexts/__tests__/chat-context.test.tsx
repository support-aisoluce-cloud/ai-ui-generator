...
// save-project is a server action that transitively imports "server-only";
// mock it so the module can load in the jsdom test environment.
vi.mock("@/actions/save-project", () => ({
  saveProject: vi.fn(),
}));
